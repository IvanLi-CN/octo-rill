...
| y9ngx | LinuxDO 绑定与用户设置页改造 | 已完成 | `y9ngx-linuxdo-user-settings/SPEC.md` | 2026-04-22 | PR #94; fast-track / unified settings page + LinuxDO binding + inline PAT fallback + PAT visual-mask guard |
...
| hgsxb | Passkey 登录与 GitHub 绑定 Onboarding | 已完成 | `hgsxb-passkey-login-onboarding/SPEC.md` | 2026-04-23 | fast-track / PR-ready / passkey login + GitHub bind onboarding + settings management + landing passkey icon + review fixes for first-paint support + today_live cutoff + pending-passkey oauth/linuxdo consumption |
