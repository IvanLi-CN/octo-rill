...
| 2x7av | Dashboard 顶部 tab 路径化与 GitHub 风格 release deep link | 已完成 | `2x7av-dashboard-tab-path-release-deep-link/SPEC.md` | 2026-04-22 | fast-track / path-backed tabs + repo-tag release locator + browser URL proof landed |
