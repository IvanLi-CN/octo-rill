...
- 2026-09-02: Removed the product Apple touch icon path, made the post-build HTML contract DOM-based and CI-gated, added approved source-to-production artwork parity, and added same-context Chromium standalone V1-to-V2 Manifest/icon retrieval coverage while preserving approved install artwork pixels.
