...
export const DEMO_SCENES: DemoScene[] = [
	...
	},
	{
		...
		description: "打开命令面板并展示本地搜索结果、lane 命中与仓库结果。",
		path: `${buildDashboardScopeHref(repoScope)}?palette=search`,
		defaultPersona: "member",
	...
	},
	{
		...
		path: `${buildDashboardScopeHref(repoScope)}?palette=actions`,
		defaultPersona: "member",
		personas: ["member", "admin"],
	},
	{
		id: "dashboard-command-admin",
		title: "Command Palette · Admin",
		description: "管理员命令面板，仅显示进入管理台的受控 action。",
		path: `${buildDashboardScopeHref(repoScope)}?palette=admin`,
