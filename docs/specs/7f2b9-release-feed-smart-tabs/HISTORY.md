...
- 2026-07-07：扩展 release smart retryable 错误分类，覆盖响应体解码、AI/GitHub 发送请求失败、缺失 AI content、DNS/TLS/proxy/连接中断与 upstream 500 等瞬时失败；配置、模型、GitHub compare 语义和 Markdown 结构错误仍保留终态。
