...
| 96dp9 | Dashboard 同步入口收敛与顺序固定 | 部分完成（2/3） | `96dp9-dashboard-sync-unification/SPEC.md` | 2026-03-27 | UI unified; storybook evidence captured; pending fast-track PR convergence |
