...
| gh3tz | 可配置 LLM 并行调度（取消固定限流） | 部分完成（3/4） | `gh3tz-llm-max-concurrency/SPEC.md` | 2026-03-09 | local impl done; cargo test + web build/e2e passed; pending PR/checks/review |
