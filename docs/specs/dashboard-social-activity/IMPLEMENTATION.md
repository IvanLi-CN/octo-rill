...
- Created: 2026-04-10
- Last: 2026-06-30
- Summary: 已交付；全部 tab 已扩展公告与 Fork 混排，专属 tabs 保持发布 / 加星 / 关注 / 日报 / 收件箱口径；桌面内容卡片项目名后补充 Release / 公告类型图标；announcement 翻译 / 润色 / detail follow-up 转交 `announcement-discussion-reading`
...
- Directory: `docs/specs/dashboard-social-activity/assets/`
...
- [x] M6: 桌面宽度下，Release 与公告内容卡片在项目名称后显示类型图标；移动端保持隐藏以避免挤占标题行。
