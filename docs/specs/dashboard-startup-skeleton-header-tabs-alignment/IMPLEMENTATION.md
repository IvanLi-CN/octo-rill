...
- Created: 2026-04-16
- Last: 2026-04-16
- Summary: 已交付；fast-track follow-up to tanstack-router-auth-boot-no-login-flicker; warm skeleton shell alignment + visual evidence
...
- `docs/specs/dashboard-startup-skeleton-header-tabs-alignment/SPEC.md`: 回填最终实现结论与视觉证据。

## 计划资产（Plan assets）

- Directory: `docs/specs/dashboard-startup-skeleton-header-tabs-alignment/assets/`
