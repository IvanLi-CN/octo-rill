...
- Created: 2026-04-22
- Last: 2026-04-24
- Summary: 已交付；path-backed tabs / repo-tag release locator / browser URL proof / post-review hardening landed；discussion canonical deep-link follow-up tracked in `announcement-discussion-reading`
...
- `docs/specs/dashboard-tab-path-release-deep-link/HISTORY.md`
...
- Directory: `docs/specs/dashboard-tab-path-release-deep-link/assets/`
