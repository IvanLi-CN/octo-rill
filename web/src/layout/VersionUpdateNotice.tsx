		...
		>
			<div className="mx-auto flex min-h-10 max-w-6xl items-center justify-between gap-3 px-6 py-2">
				...
				<Button
					...
					variant="ghost"
					size="sm"
					className="h-7 px-2.5 text-xs text-amber-950 hover:bg-amber-100 hover:text-amber-950"
					onClick={refreshPage}
				>
