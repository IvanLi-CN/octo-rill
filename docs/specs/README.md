...
| --- | --- | --- | --- | --- | --- |
| nbz5z | Translation worker board follow-up | 待实现 | `nbz5z-translation-worker-board/SPEC.md` | 2026-03-09 | 3 general + 1 user_dedicated worker board, request_origin split |
