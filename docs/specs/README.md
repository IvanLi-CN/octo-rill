...
| gr8kr | GitHub 登录态持久化与稳定 session cookie | 部分完成（3/4） | `gr8kr-persistent-session-auth/SPEC.md` | 2026-04-21 | fast-track / 30d sliding session + stable cookie-name config |
