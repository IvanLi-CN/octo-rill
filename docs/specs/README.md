...
| hgsxb | Passkey 登录与 GitHub 绑定 Onboarding | 已完成 | `hgsxb-passkey-login-onboarding/SPEC.md` | 2026-04-22 | fast-track / PR-ready / passkey login + GitHub bind onboarding + settings management |
