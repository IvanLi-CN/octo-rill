...
- Feed、日报、Inbox 增加新内容提示；Feed 命中更新后会后台刷新当前列表，把提示放在新旧内容之间，揭示后对新卡片应用 session-only 圆点暗示。
- Storybook 覆盖 Feed 新批次、Feed 连续推送、日报新批次和 Inbox 新线程状态，并提供视觉证据 canvas；连续推送 Story 会锚定到新旧内容分割线，模拟低打扰阅读体验。
