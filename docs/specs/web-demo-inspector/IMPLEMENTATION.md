...
- [x] M2: 页面级 surface 的 mock-only handlers / SSE / simulated writes 补齐。
...
- [x] M5: 页面级 Demo 深链、fixture/transport 和 Playwright 回归覆盖补齐，页面/app-shell Story 移除；Storybook 保留组件与 fragment 职责。
