...
- `web/src/settings/reactionTokenEditor.ts`
- `web/e2e/dashboard-social-activity.spec.ts`
- `docs/specs/dashboard-startup-request-storm/SPEC.md`
- `docs/specs/README.md`

### Out of scope

- `src/**`
- `web/src/version/versionMonitor.tsx`
- `web/src/pages/Settings.tsx` 的 UI 结构与 section 信息架构
...
- `cd web && bun run e2e -- dashboard-social-activity.spec.ts app-auth-boot.spec.ts`
...
- `docs/specs/linuxdo-user-settings/SPEC.md`
- `web/src/pages/Dashboard.tsx`
- `web/src/settings/reactionTokenEditor.ts`
