...
- 2026-09-02: Removed the product Apple touch icon path, made the post-build HTML contract DOM-based, and added same-context Chromium V1-to-V2 Manifest/icon retrieval coverage while preserving approved install artwork pixels.
