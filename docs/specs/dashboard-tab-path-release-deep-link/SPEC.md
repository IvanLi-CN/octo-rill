# Dashboard 顶部 tab 路径化与 GitHub 风格 release deep link
...
- 通过 Storybook、Playwright、router helper、后端解析测试与 targeted browser URL 验证固化该路由契约。
...
- `docs/specs/web-lazy-route-code-splitting/SPEC.md`
