...
- `docs/specs/multi-github-linuxdo-onboarding/SPEC.md`: 维护接口契约、视觉证据与 spec sync 结果。
- `docs/specs/multi-github-linuxdo-onboarding/contracts/db.md`: 明确 runtime 真相源与 legacy 保留边界，并记录后续 cleanup 建议。

## 计划资产（Plan assets）

- Directory: `docs/specs/multi-github-linuxdo-onboarding/assets/`
