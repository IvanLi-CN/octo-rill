...
| yhyaj | 共享 Markdown GitHub 链接短标签与自动换行防裁剪 | 部分完成（3/4） | `yhyaj-shared-markdown-github-link-wrap/SPEC.md` | 2026-04-21 | local implementation + Storybook evidence + validation + review clear landed; push/PR pending owner screenshot approval |
