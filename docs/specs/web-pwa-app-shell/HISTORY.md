...
- 2026-09-02: Removed the product Apple touch icon path, made the post-build HTML contract DOM-based and CI-gated, added approved source-to-production artwork parity, and added browser-owned Chromium V1-to-V2 retrieval coverage plus an opt-in real-installed ChromeOS lifecycle path while preserving approved install artwork pixels.
