...
- Storybook covers the shared update notice states and the Landing offline boot fallback plus Dashboard authenticated offline cache/no-cache states as stable visual evidence sources.
